...
async function startServer() {
  ...
  app.use((req, res, next) => {
    ...
    res.header("Content-Security-Policy",
      ...
      "connect-src 'self' https://accounts.google.com https://cloudflareinsights.com https://static.cloudflareinsights.com https://performance.typekit.net https://pub-203143bd86174070b67f8f64a13a65c2.r2.dev https://viacep.com.br; " +
