...
const CODEGEN_STUB_MAP = [
  ...
  // Os outros 59 arquivos da pasta specs_DEPRECATED (10 componentes + 49
  // módulos) — cada um com seu stub preciso (requireNativeComponent ou
  // NativeModules, preservando o comportamento real). NativeSampleTurboModule
  // é o único com stub vazio aqui (é só um módulo de exemplo interno da Meta,
  // confirmado não usado por apps reais).
  { frag: "/react-native/src/private/specs_DEPRECATED/components/ActivityIndicatorViewNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "ActivityIndicatorViewNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/AndroidHorizontalScrollContentViewNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "AndroidHorizontalScrollContentViewNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/AndroidSwipeRefreshLayoutNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "AndroidSwipeRefreshLayoutNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/AndroidSwitchNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "AndroidSwitchNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/DebuggingOverlayNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "DebuggingOverlayNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/ProgressBarAndroidNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "ProgressBarAndroidNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/PullToRefreshViewNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "PullToRefreshViewNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/RCTModalHostViewNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "RCTModalHostViewNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/RCTSafeAreaViewNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "RCTSafeAreaViewNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/SwitchNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "SwitchNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/components/UnimplementedNativeViewNativeComponent", stub: path.join(CODEGEN_STUBS_DIR, "UnimplementedNativeViewNativeComponent.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeAccessibilityInfo", stub: path.join(CODEGEN_STUBS_DIR, "NativeAccessibilityInfo.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeAccessibilityManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeAccessibilityManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeActionSheetManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeActionSheetManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeAlertManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeAlertManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeAnimatedModule", stub: path.join(CODEGEN_STUBS_DIR, "NativeAnimatedModule.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeAnimatedTurboModule", stub: path.join(CODEGEN_STUBS_DIR, "NativeAnimatedTurboModule.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeAppState", stub: path.join(CODEGEN_STUBS_DIR, "NativeAppState.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeAppearance", stub: path.join(CODEGEN_STUBS_DIR, "NativeAppearance.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeBlobModule", stub: path.join(CODEGEN_STUBS_DIR, "NativeBlobModule.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeClipboard", stub: path.join(CODEGEN_STUBS_DIR, "NativeClipboard.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeDevLoadingView", stub: path.join(CODEGEN_STUBS_DIR, "NativeDevLoadingView.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeDevSettings", stub: path.join(CODEGEN_STUBS_DIR, "NativeDevSettings.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeDeviceEventManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeDeviceEventManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeDeviceInfo", stub: path.join(CODEGEN_STUBS_DIR, "NativeDeviceInfo.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeDialogManagerAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativeDialogManagerAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeExceptionsManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeExceptionsManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeFileReaderModule", stub: path.join(CODEGEN_STUBS_DIR, "NativeFileReaderModule.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeFrameRateLogger", stub: path.join(CODEGEN_STUBS_DIR, "NativeFrameRateLogger.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeHeadlessJsTaskSupport", stub: path.join(CODEGEN_STUBS_DIR, "NativeHeadlessJsTaskSupport.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeI18nManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeI18nManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeImageEditor", stub: path.join(CODEGEN_STUBS_DIR, "NativeImageEditor.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeImageLoaderAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativeImageLoaderAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeImageLoaderIOS", stub: path.join(CODEGEN_STUBS_DIR, "NativeImageLoaderIOS.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeImageStoreAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativeImageStoreAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeImageStoreIOS", stub: path.join(CODEGEN_STUBS_DIR, "NativeImageStoreIOS.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeIntentAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativeIntentAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeJSCHeapCapture", stub: path.join(CODEGEN_STUBS_DIR, "NativeJSCHeapCapture.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeKeyboardObserver", stub: path.join(CODEGEN_STUBS_DIR, "NativeKeyboardObserver.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeLinkingManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeLinkingManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeLogBox", stub: path.join(CODEGEN_STUBS_DIR, "NativeLogBox.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeModalManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeModalManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeNetworkingAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativeNetworkingAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeNetworkingIOS", stub: path.join(CODEGEN_STUBS_DIR, "NativeNetworkingIOS.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativePermissionsAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativePermissionsAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativePlatformConstantsAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativePlatformConstantsAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativePlatformConstantsIOS", stub: path.join(CODEGEN_STUBS_DIR, "NativePlatformConstantsIOS.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativePushNotificationManagerIOS", stub: path.join(CODEGEN_STUBS_DIR, "NativePushNotificationManagerIOS.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeRedBox", stub: path.join(CODEGEN_STUBS_DIR, "NativeRedBox.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeSampleTurboModule", stub: path.join(CODEGEN_STUBS_DIR, "NativeSampleTurboModule.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeSegmentFetcher", stub: path.join(CODEGEN_STUBS_DIR, "NativeSegmentFetcher.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeSettingsManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeSettingsManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeShareModule", stub: path.join(CODEGEN_STUBS_DIR, "NativeShareModule.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeSoundManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeSoundManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeSourceCode", stub: path.join(CODEGEN_STUBS_DIR, "NativeSourceCode.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeStatusBarManagerAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativeStatusBarManagerAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeStatusBarManagerIOS", stub: path.join(CODEGEN_STUBS_DIR, "NativeStatusBarManagerIOS.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeTiming", stub: path.join(CODEGEN_STUBS_DIR, "NativeTiming.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeToastAndroid", stub: path.join(CODEGEN_STUBS_DIR, "NativeToastAndroid.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeUIManager", stub: path.join(CODEGEN_STUBS_DIR, "NativeUIManager.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeVibration", stub: path.join(CODEGEN_STUBS_DIR, "NativeVibration.js") },
  { frag: "/react-native/src/private/specs_DEPRECATED/modules/NativeWebSocketModule", stub: path.join(CODEGEN_STUBS_DIR, "NativeWebSocketModule.js") },
