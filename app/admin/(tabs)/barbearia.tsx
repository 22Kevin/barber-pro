        ...
        filiais.map((b: any) => (
          <View key={b.id} style={filialStyles.filialCard}>
            <View style={filialStyles.filialIcon}>
              <IconSymbol name="storefront" size={24} color="#C9A84C" />
            </View>
            <View style={{ flex: 1 }}>
...
const filialStyles = StyleSheet.create({
  ...
  filialIcon: { width: 56, height: 56, borderRadius: 10, backgroundColor: "#C9A84C20", alignItems: "center", justifyContent: "center" },
