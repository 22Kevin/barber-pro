...
function createStyles(c: ReturnType<typeof import("@/hooks/use-colors").useColors>) {
  ...
  addBtn: { flexDirection: "row", alignItems: "center", backgroundColor: "#C9A84C", borderRadius: 10, paddingHorizontal: 8, paddingVertical: 8, gap: 4 },
  addBtnText: { color: "#0A0A0A", fontWeight: "700", fontSize: 13 },
  expenseBtn: { flexDirection: "row", alignItems: "center", backgroundColor: "#F4433622", borderRadius: 10, paddingHorizontal: 8, paddingVertical: 8, gap: 4, borderWidth: 1, borderColor: "#F4433644" },
