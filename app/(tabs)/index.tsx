...
export default function HomeScreen() {
  ...
  useEffect(() => {
    Animated.sequence([
      Animated.parallel([
        Animated.spring(logoScale, { toValue: 1, tension: 60, friction: 8, useNativeDriver: ND }),
        Animated.timing(logoOpacity, { toValue: 1, duration: 400, useNativeDriver: ND }),
      ]),
      Animated.parallel([
        Animated.timing(nameOpacity, { toValue: 1, duration: 280, useNativeDriver: ND }),
        Animated.timing(nameSlide, { toValue: 0, duration: 280, useNativeDriver: ND }),
      ]),
      Animated.timing(taglineOpacity, { toValue: 1, duration: 220, useNativeDriver: ND }),
      Animated.timing(dividerScale, { toValue: 1, duration: 320, useNativeDriver: ND }),
      Animated.parallel([
        Animated.timing(optionsOpacity, { toValue: 1, duration: 300, useNativeDriver: ND }),
        Animated.timing(optionsSlide, { toValue: 0, duration: 300, useNativeDriver: ND }),
      ]),
      Animated.timing(footerOpacity, { toValue: 1, duration: 200, useNativeDriver: ND }),
    ]).start();
  }, []);
      ...
      <SafeAreaView style={styles.safe} edges={["top", "left", "right", "bottom"]}>
        <View style={styles.container}>
          ...
          <Animated.View style={[styles.options, { opacity: optionsOpacity, transform: [{ translateY: optionsSlide }] }]}>
            ...
            <Pressable
              style={({ pressed }) => [styles.optionCard, styles.registerCard, pressed && styles.pressed]}
            ...
            <Pressable
              style={({ pressed }) => [styles.optionCard, styles.adminCard, pressed && styles.pressed]}
...
const styles = StyleSheet.create({
  ...
  adminCard: { backgroundColor: "#C9A84C", borderColor: "#C9A84C", elevation: 8, marginTop: 0 },
  registerCard: { backgroundColor: "#0A0A0A", borderColor: "#C9A84C44", borderWidth: 1.5, marginBottom: 0 },
